...
function runRace(raceID) {
	...
	try {
		...
		console.log(`Error by runRace: ${error}`);
	}
}
...
async function runCountdown() {
	try {
		...
		}).catch(err => console.log("CountDown problem: " + err))
	} catch (error) {
		console.log(error);
	}
}
...
function getTracks() {
	return fetch(`${SERVER}/api/tracks`)
		...
		.then(result => result)
		.catch(err => console.log("Err by getTracks:" + err))
}
...
function getRace(id) {
	...
	return fetch(`${SERVER}/api/races/${id}`)
		.then(result => result.json())
		.catch(err => console.log("Err by getRace:" + err))
}
...
function accelerate(id) {
	fetch(`${SERVER}/api/races/${id}/accelerate`, {
		...
		.catch(err => console.log("Err by accelerate:", err))
}
